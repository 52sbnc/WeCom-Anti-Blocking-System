...
<body>
    <div class="container">
        ...
        <?php if ($step == 1 && !$submit_success): ?>
            ...
            <ul>
                ...
                <li><a href="?step=2&type=存在侵权行为&code=<?php echo $_GET['code'] ?? ''; ?>">存在侵权行为</a></li>
                <li><a href="?step=2&type=发布仿冒品信息&code=<?php echo $_GET['code'] ?? ''; ?>">发布仿冒品信息</a></li>
                <li><a href="?step=2&type=冒充他人&code=<?php echo $_GET['code'] ?? ''; ?>">冒充他人</a></li>
        ...
        <?php elseif ($step == 2 && !$submit_success): ?>
            ...
            <ul>
                ...
                <li><a href="?step=3&type=<?php echo $main_type; ?>&subtype=暴力&code=<?php echo $_GET['code'] ?? ''; ?>">暴力</a></li>
                <li><a href="?step=3&type=<?php echo $main_type; ?>&subtype=垃圾广告&code=<?php echo $_GET['code'] ?? ''; ?>">垃圾广告</a></li>
                <li><a href="?step=3&type=<?php echo $main_type; ?>&subtype=其他&code=<?php echo $_GET['code'] ?? ''; ?>">其他</a></li>
            </ul>
            <p><a href="./tip.html">投诉须知</a></p>
                ...
                <ul>
                    ...
                    <li style="padding-bottom: 40px; position: relative;">
                        <div class="required-label">
                            <span class="star">*</span>问题描述
                        </div>
                        <textarea placeholder="请详细描述你遇到的问题，有助于我们快速处理" maxlength="200" class="textarea" id="problem-description" name="problem" required><?php echo $_POST['problem'] ?? ''; ?></textarea>
                    ...
                    <li>
                            ...
                            <span class="imgnumber-left">图片上传(选填)</span>
    ...
    <script>
        ...
        const imgLength = document.getElementById('imglength');
        ...
        function updateImageCount() {
            imgLength.textContent = `${uploadedImages.length}张图片`;
        ...
        function checkFormValidity() {
            const isTextValid = textarea.value.trim().length > 0;
            submitBtn.disabled = !isTextValid;
        }
